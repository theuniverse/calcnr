...
public class CLNumberRestrictionRule extends GenericRule {
	
	String toRegexPattern = "\\Q(\\ge\\E\\d+ R\\Q)\\E";
	String nRegexPattern = "\\d+";
	Pattern p, pn;
	Matcher m, mn;

	public CLNumberRestrictionRule(){
		this.fromPattern = "C";
		this.toPattern = "(\\ge\\n R)";
	...
	public GenericElement createElement(ALCNRKB kb) {
		return new LNumberRestrictionConcept();
	}
	...
	public void addMap(int index, Hashtable<Integer, GenericElement> map,
			...
			GenericElement ge) {
		int rNumber = ((LNumberRestrictionConcept)ge).n, count = 0;
